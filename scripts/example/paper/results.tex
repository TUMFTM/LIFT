...
\newcommand{\circleprogress}[6]{
    ...
    \foreach \idx/\colorname/\value in {2/tumblue/#4, 1/tumorange/#5, 0/tumgreen/#6} {
        ...
        \drawwedge{#1}{\innerR}{\outerR}{\value}{\colorname}
    }

    % Add values
    \foreach \idx/\colorname/\value in {2/tumblue/#4, 1/tumorange/#5, 0/tumgreen/#6}{
        \pgfmathsetmacro{\share}{round(\value * 100)}
        \pgfmathsetmacro{\labelheight}{\wedgearcrouter - \idx * (\wedgearcwidth + \wedgearcspace) - \wedgearcwidth/2}
        \node[
            font=\scriptsize,
            text=\colorname, % or do text=black and reduce contour line width to 0.25
            anchor=east,
            inner sep=0pt
        ] at ($(#1) + (-0.01, \labelheight)$) {\contour{white}{\pgfmathprintnumber[precision=0]{\share}\%}};
    }
...
\newcommand{\emissionbar}[6]{
    ...
    \foreach \idx/\colorname/\value in {0/tumblue/#4, 1/tumorange/#5, 2/tumgreen/#6} {
        ...
        \node[
            ...
            anchor=north,
            inner sep=0pt
        ] at ($(#1) + (\barx, \bary + \baryoffset + \emissionbarlabelspace)$) {\contour{white}{\pgfmathprintnumber[precision=0]{\value}\,t}};
    }
