...
DEF_ECONOMICS = DefinitionEconomics(
    settings_discount_rate=SettingsSlider(
        min_value=0.0, max_value=20.0, value=5.0, step=0.1, factor=0.01, format="%0.1f"
    ),
    ...
    settings_opex_spec_grid_buy=SettingsSlider(
        min_value=0.0, max_value=0.5, value=0.23, step=0.01, factor=1e-3, format="%0.2f"
    ),
    settings_opex_spec_grid_sell=SettingsSlider(
        min_value=0.0, max_value=0.5, value=0.06, step=0.01, factor=1e-3, format="%0.2f"
    ),
    ...
    settings_opex_spec_route_charging=SettingsSlider(
        min_value=0.0, max_value=2.0, value=0.49, step=0.01, factor=1e-3, format="%0.2f"
    ),
    ...
    settings_insurance_frac=SettingsSlider(
        min_value=0.0, max_value=10.0, value=2.0, step=0.1, factor=0.01, format="%0.1f"
    ),
...
DEF_ESS = dict(capex_spec=0.45, capem_spec=0.069, ls=9)
DEF_GRID = dict(
    capex_spec=0.2,
