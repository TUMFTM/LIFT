...
CHARGERS = dict(
    ac=ChargerDefinition(
        ...
        settings_expansion=SliderSettings(min_value=0, max_value=100, value=0, step=1),
    ...
    dc=ChargerDefinition(
        ...
        settings_preexisting=SliderSettings(min_value=0, max_value=100, value=0, step=1),
        settings_expansion=SliderSettings(min_value=0, max_value=100, value=0, step=1),
