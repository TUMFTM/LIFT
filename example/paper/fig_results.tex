...
%    \draw[color=red] (0, 1.2) rectangle ++(-\figwidth*\figfracleft, -\figheight);
    ...
    \node (legendcolumnleft) at ($(legendcenter) + (-1.55 * \legendelementwidth, 0)$) {};
    \node (legendcolumncenter) at ($(legendcenter) + (-0.52 * \legendelementwidth, 0)$) {};
    \node (legendcolumnright) at ($(legendcenter) + (0.55*\legendelementwidth, 0)$) {};
    ...
    \legendlabel{$(legendcolumncenter)+(0, \legendvspace/2)$}{II: Fleet Electrification}
    ...
    \begin{groupplot} [
        ...
        ylabel={Present costs in million €},
        grid=major,
        minor x tick num = 4,
        xtick={0,5,10,15,20},
    ...
    \nextgroupplot[ymax=45]
    \createlinebarplot{out/A_data_time.csv}{out/A_data_total.csv}
    \node at (current axis.east) (node1) {};
    \nextgroupplot[ymax=13]
    \createlinebarplot{out/B_data_time.csv}{out/B_data_total.csv}
    \node at (current axis.east) (node2) {};
    \nextgroupplot[ymax=11]
    \createlinebarplot{out/C_data_time.csv}{out/C_data_total.csv}
    \node at (current axis.east) (node3) {};

    \end{groupplot}

    \gridplots{node1}{A}{out/A_data_total.csv}
    \gridplots{node2}{B}{out/B_data_total.csv}
    \gridplots{node3}{C}{out/C_data_total.csv}
