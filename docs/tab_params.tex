...
$C_{\text{Rate}}$ & C-Rate des Speichers & $0.5$ & \si{\per\hour} & Annahme \\
$SOC_{t=0}$ & SOC des Speichers zum Startzeitpunkt & $50$ & \si{\percent} & Annahme \\
\midrule
...
$e_{\text{pub}}$ & \ac{co2}-Emissionen Strommix 2023 öffentliches Laden & $0.386$ & \si{\kilogram\per\kwh} & \cite{UBA_2025} \\
\midrule
...
$c_{\text{toll}}^{\text{ICEV}}$ & Mautkosten \acs{icev} & $0.137$ & \si{\euro\per\kilo\meter} & \cite{bundesministeriumfurverkehr_gebuhrenstruktur_2024} \\
