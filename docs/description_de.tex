...
Alle in \ac{lift} verwendeten Parameter sowie deren Standardwerte und Quellen sind in der folgenden \autoref{tab:parameters} zusammengefasst.
Parameter ohne angegebenen GUI-Standardwert können in der Benutzeroberfläche gewählt werden.
...
\caption{Parameter von \ac{lift} – Teil 1: Simulation bis Stationärspeicher}\label{tab:parameters1}\\
...
$t_{\text{sim}}^{\text{start}}$ & Simulationsstart & — & 01.01.2023 00:00 (UTC+1) & Startzeitpunkt der Simulation & — \\
$t_{\text{sim}}$ / $t_{\text{sim,y}}$ & Simulationsdauer & Tage / Jahre & 365 / 1 & Länge des simulierten Zeitraums & — \\
...
$t_{\text{prj}}$ & Projektlaufzeit & Jahre & 18 & Betrachtungszeitraum Amortisation & Annahme\\
...
$c^{\text{GCP}}_{\text{Invest}}$ & Investitionskosten & €/kW & 200 & Netzanschlussverstärkung & Annahme \\
