...
Die angenommenen spezifischen Kosten $c^{Netz}_{Invest}$, spezifischen Emissionen $c^{PV}_{Invest}$ und die Lebensdauer $ls^{Netz}$ sind im \todo[inline]{Anhang verlinken} aufgeführt.\\\\
...
Diese werden nach \autoref{eq:capex_capem} berechnet.
Die angenommenen spezifischen Kosten $c^{PV}_{Invest}$, spezifischen Emissionen $c^{PV}_{Invest}$ und die Lebensdauer $ls^{PV}$ sind im \todo[inline]{Anhang verlinken} aufgeführt.\\\\
\textbf{Betriebskosten und -emissionen}\\
...
Diese werden nach \autoref{eq:capex_capem} berechnet.
Die angenommenen spezifischen Kosten $c^{Speicher}_{Invest}$, spezifischen Emissionen $c^{Speicher}_{Invest}$ und die Lebensdauer $ls^{Speicher}$ sind im \todo[inline]{Anhang verlinken} aufgeführt.\\\\
\textbf{Betriebskosten und -emissionen}\\
Während des Betriebs entstehen weder Kosten noch Emissionen.
...
Die in der GUI vordefinierten Ladepunkttypen sind im \todo[inline]{Anhang} aufgeführt.
...
Die bei der Herstellung eines Ladepunkts entstehenden Emissionen $CO2^{\text{Ladepunkt}, m n}_\text{Invest, einmalig}$ sind im \todo[inline]{Anhang} aufgeführt.
...
Die bei der Herstellung eines Fahrzeugs entstehenden Emissionen $CO2^{\text{Fahrzeug}, f n}_\text{Invest, einmalig}$ sind im \todo[inline]{Anhang} aufgeführt.
...
Bis auf den Anteil der mautpflichtigen Strecke und den spezifischen Diesel- und Mautkosten, die in der GUI eingestellt werden können, werden alle Parameter mit vordefinierten Werten parametriert, die im \todo[inline]{Anhang} aufgeführt sind.
Die im Betrieb entstehenden Emissionen der Dieselfahrzeuge lassen sich aus dem benötigten Dieselvolumen und den spezifischen Emissionen für Diesel pro Liter $co2^{Diesel}$ (vordefiniert und im \todo[inline]{Anhang} aufgeführt) berechnen:
\begin{equation}
...
\todo[inline]{Hier noch alle verwendete Werte aus den JSON Files eintragen}
