...
\DeclareAcronym{lkw}{short=Lkw, long=Lastkraftwagen,}
...
\DeclareAcronym{pkw}{short=Pkw, long=Personenkraftwagen,}
...
\DeclareAcronym{zgg}{short=zGG, long=zulässiges Gesamtgewicht,}


% Set page margins
\geometry{top=1in, bottom=1in, left=1in, right=1in}

\title{\Large{\textbf{LIFT}\\Logistics Infrastructure \& Fleet Transformation\\Dokumentation und Anwenderleitfaden}}
\author[1]{\small{Brian Dietermann}}
\author[1]{\small{Anna Paper}}
\author[1]{\small{Philipp Rosner}}
\affil[1]{\small{Lehrstuhl für Fahrzeugtechnik, Technische Universität München}}
\date{\small{\today}}
\notitlepage
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1.0\textwidth]{gui_v1-0-0_de}
    \caption{Die \ac{gui} von \ac{lift} in Version 1.0.0 mit der linken Seitenleiste zur Eingabe der Szenario-Parameter und exemplarischer Darstellung von Ergebnissen im rechten Hauptbereich.}
    \label{fig:gui}
\end{figure}
...
Sollte die Be\-rück\-sichtigung eines Blocks bzw. Systems nicht gewünscht sein, dann kann dies durch entsprechende Parameterwahl (z.\,B.~$P=0$) erreicht werden.
